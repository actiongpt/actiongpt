...
class TEACH(BaseModel):
    ...
    def allsplit_step(self, split: str, batch, batch_idx):
        ...
        # print("On the highhh")
        # print('batch["motion_feats_0"].shape')
        # print(batch["motion_feats_0"].shape)
        # print('batch["motion_feats_1"].shape')
        # print(batch["motion_feats_1"].shape)
        # print('batch["text_0"].shape')
        # print(len(batch["text_0"]))
        # print('batch["text_1"].shape')
        # print(len(batch["text_1"]))
        ...
        # print("latent_vector_0_T.shape ====== TEXT")
        # print(latent_vector_0_T.shape)
        #### Decode into motions
        ## First motion pass
        # Decode the latent vector to a motion
        ...
        if self.motion_branch:
            # print("*********************************motion branch*********************************")
            # print("input_motion_feats_0 === MOTION")
            # print(input_motion_feats_0.shape)
            #### Encode the first motion
            latent_vector_0_M, distribution_0_M = self.encode_data(input_motion_feats_0, return_latent=True)
            # print("latent_vector_0_M === MOTION")
            # print(latent_vector_0_M.shape)
            output_features_0_M = self.motiondecoder(latent_vector_0_M, lengths=length_0)
            output_features_0_M_lst = [feats[:len0] for feats, len0 in zip(output_features_0_M, length_0)]

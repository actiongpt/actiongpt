...
def add_visualize_options(parser):
    ...
    group.add_argument("--generations", type=str, default='./generations',
                       help="dir with npy files of all generations")    
...
def parser(checkpoint=True):
    ...
    if checkpoint:
        ...
        return parameters, folder, checkpoint, epoch, parameters["generations"]
    else:
        return parameters

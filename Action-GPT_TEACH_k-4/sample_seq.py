        ...
        for keyid in (pbar := tqdm(keyids)):
            ...
            for index in range(cfg.number_of_samples):
                ...
                if cfg.naive:
                    ...
                    motion,rots,trans = model.forward_seq(cur_texts, cur_lens,
                ...
                if cfg.number_of_samples > 1:
                    ...
                    # np.save("/ssd_scratch/cvit/sai.shashank/teach_actgptk-4_data/rots/"+f"{keyid}.npy",rots)
                    # np.save("/ssd_scratch/cvit/sai.shashank/teach_actgptk-4_data/trans/"+f"{keyid}.npy",trans)
